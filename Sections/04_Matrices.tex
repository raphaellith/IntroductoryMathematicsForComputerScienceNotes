...
%
\begin{itemize}
    \item A vector space \(U\) of \(m\) dimensions, with a specified set of basis vectors.
    \item A vector space \(V\) of \(n\) dimensions, with a specified set of basis vectors.
\end{itemize}
%
...
\[
M = \begin{bmatrix}
    \color{BrickRed}\square & \color{MidnightBlue}\square & \color{ForestGreen}\square\\
    \color{BrickRed}\square & \color{MidnightBlue}\square & \color{ForestGreen}\square\\
\end{bmatrix}
\]
%
