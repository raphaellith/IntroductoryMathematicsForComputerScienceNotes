...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\linewidth]{CartesianCoordsOnCircle.png}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.75]
        ...
        \begin{scope}[shift={(9, 0)}]
            ...
            \draw[line width=2pt, ForestGreen, -stealth] (0,0)--(4,3) node[pos=3/4, anchor=east, shift={(0, 0.1)}]{\(z_1+z_2\)};
        \end{scope}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.9]
        ...
        \begin{scope}[shift={(9, 0)}]
            ...
            \draw[line width=2pt, ForestGreen, -stealth] (0,0)--(1,7) node[pos=3/4, anchor=west, shift={(0, 0.1)}]{\(z_1 z_2\)};
        \end{scope}
