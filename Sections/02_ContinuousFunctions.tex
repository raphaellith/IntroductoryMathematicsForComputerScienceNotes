...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \draw[ForestGreen, thick, latex-latex] (2.5, 6) -- (3, 6) node[pos=0.5, above] {\(\delta\)};

        \draw[ForestGreen, thick, latex-latex] (3, 6) -- (3.5, 6) node[pos=0.5, above] {\(\delta\)};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \draw[ForestGreen, thick, latex-latex, shift={(0, 0.1)}] (2.5, 6) -- (3, 6) node[pos=0.5, above] {\(\delta\)};

        \draw[ForestGreen, thick, latex-latex, shift={(0, 0.1)}] (3, 6) -- (3.5, 6) node[pos=0.5, above] {\(\delta\)};
    \end{tikzpicture}
