...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \caption{A demonstration of the squeeze theorem. The red curve represents the sequence \(v_n = (\sin{n})/n\). The green curves represent the sequences \(u_n = -1/n\) and \(w_n = 1/n\).}
